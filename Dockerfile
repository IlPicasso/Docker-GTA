...
RUN yum install -y epel-release remi-release \
    ...
    && yum install -y mc git wget tar htop bash-completion net-tools tcpdump telnet supervisor libstdc++-devel compat-libstdc++-33.i686 libstdc++.i686 libstdc++-devel.i686 glibc-devel.i686 \
    && adduser -D -h /home/container container
